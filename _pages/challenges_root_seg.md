...
<div>
  <img src="/assets/img/image_2.png" style="width:100%">
  <figcaption><strong>Figure 2:</strong> Multi-class segmentation masks (Green = main root, blue = lateral root)</figcaption>
</div>
...
<div>
  <img src="/assets/img/image_3.png"  style="width:33%">
  <figcaption><strong>Figure 3:</strong> Folder organization.</figcaption>
</div>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Gaggion, N., Ariel, F., Daric, V., Lambert, É., Legendre, S., Roulé, T., Camoirano, A., Milone, D., Crespi, M., Blein, T. and Ferrante, E., 2020. *ChronoRoot: High-throughput phenotyping by deep segmentation networks reveals novel temporal parameters of plant root system architecture.* [Link: BiorXiv](https://www.biorxiv.org/content/10.1101/2020.10.27.350553v1)
